...
<input type="text" name="name_of_pharmacist" placeholder= "name_of_pharmacist" size="45" required /> 
<br>
<label> Company Name </label>   
<input type="text" name=" Company name" placeholder= " Company name " size="45" required /> 
<br>
...
if(isset($_POST['Add']))
{
    $name_of_pharmacist = $_POST['name_of_pharmacist'];
    ...
    $sql_query = "INSERT INTO pharmacist (name_of_pharmacist,Company_name,Qualification,phone_no,email,experience) VALUES ('$name_of_pharmacist','$Company_name','$Qualification','$phone_no','$email','$experience')";
