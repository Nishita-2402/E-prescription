...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="Index_1.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i></h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="Index_1.php" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6></h6></a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="contact.html" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6></h6></a>
          </li>
        </ul>
      </div>
    </div>
              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <div class="row">
                 ...
                 <!--  <div class="col-md-8" style="margin-top: 10%">
                    <a href="Index_1.php" class="btn btn-primary">Back</a></div> -->
                </div>
              </form>
            </center>
            </div>
